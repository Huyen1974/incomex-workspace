...
## Đang làm
- `work/hpml-view-for-user/` · HVU-ARCHIVE01 · P28 ACCEPT + P29 Host resolved fake READY/close semantics; PROMPT updated, chờ pin READY mới rồi giao Claude Code CLI.
