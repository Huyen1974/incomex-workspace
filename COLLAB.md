...
## Prompt
PROMPT.md | R03-FILE-LIFECYCLE-20260919-01 | DRAFT — final 29-capability + root/client/D12/undo semantics; mọi REVIEWED/READY cũ vô hiệu | RUN: CẤM cho tới Claude REVIEWED@SHA mới + Host READY@cùng SHA · Báo cáo: KB §13.11
