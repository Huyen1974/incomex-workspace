...
- **- **Ưu tiên 3 · HJW** — `work/hermes-joint-workspace/` · Host GPT. HJW.2B DỪNG G0.2; P10 ACCEPTED. PROMPT HJW.2B1 đã sửa tại `e05910bf…`; **chờ Claude ký lại đúng SHA mới trước READY**.
...
- - `work/hermes-joint-workspace/` · HJW · Host GPT · hậu kiểm Hermes + P10 đã xử lý; PROMPT HJW.2B1 DRAFT `e05910bf…`; **chờ Claude REVIEWED@e05910bf… rồi GPT READY**.
...
- - NEXT: HJW: Claude đọc AGENTS → COLLAB → PROMPT `e05910bf…`, chỉ review P10/A6 không mutation → nếu ACCEPT thì GPT Host READY/RUN.
