...
- **Ưu tiên 3 · HJW** — `work/hermes-joint-workspace/` · Host GPT. HJW.2B DỪNG G0.2; D11 giữ nguyên. PROMPT HJW.2B1 đã làm sạch tại `9153394d…`, P09 ACCEPTED; **chờ Hermes hậu kiểm trước READY**.
