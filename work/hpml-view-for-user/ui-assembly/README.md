...
B2 gồm pipeline + webhook/backstop, đã triển khai; evidence tại COLLAB và báo cáo KB hvu-ui03-progress.md (phần B2). B3 Surface và current actor không thuộc lượt này. `work/hpml-view-for-user/view.html` là app dashboard, được loại khỏi nhánh tự mirror tài liệu; không nhúng app cũ lồng vào chính dashboard. HTML các công việc khác vẫn tự đổ theo khai báo/default. App live chỉ build/deploy có kiểm soát tại VPS. Runtime rollback và vận hành: scripts/hvu-b2/README.md ở repo web-test (VPS SSOT).
