# Gate3–4 — chỉ mục evidence Rev2; hiện hành theo bản đồ v1.6.20

> **Chỉ đạo tiếp theo12/09:** [Mẫu tạo quy trình tại root](../TAO-MOT-QUY-TRINH.html) đã chuyển sang menu/ảnh lớn; CHỜ OWNER DUYỆT MẪU. [Hồ sơ hiện hành](../KHO/11-evidence/ban-do-buoc/pha-b-v1.6.20/README.md). SSOT/bản đồ chỉ đăng ký link theo ngoại lệ PM; dataset, Gate và proof không thay đổi.


**Hiện hành ·12/09/2026:** PM v2 mở lại Gate1 completeness; Gate2 PARTIAL, giữ acceptance design cũ; Gate3/4 PARTIAL và tạm dừng khóa cuối/mở rộng. Gate5–7 NOT STARTED. D04 **DECIDED / OWNER ACCEPT ·11/09/2026**, chỉ nghĩa vai, không cấp quyền production. [Bản đồ từng bước](../BAN-DO-BUOC-UI-AGENT.html) đã nộp **PhaB**, còn blocker9hàng lịch sử; Owner đã chỉ đạo tiếp tục. SSOT kiến trúc/trạng thái vẫn là file cấu trúc hệ thống.

Thư mục này giữ proof/bàn giao Rev2 v1.6.18 theo đúng thời điểm. Các nhãn D04 pending/next vá6gap trong báo cáo/JSON/log cũ là **lịch sử đã được PM v2 thay**, không lệnh thực hiện tiếp. Lab đã dọn; replay/evidence giữ nguyên. Sáu gap là đầu vào bản đồ, không toàn bộ hệ còn thiếu. Snapshot/ZIP đã niêm phong không sửa.

## Đọc ít, đúng việc

1. Owner/Agent: mở [bản đồ PhaB](../BAN-DO-BUOC-UI-AGENT.html) trước. [Báo cáo Rev2](BAO-CAO-GUI-PM.md) + [ZIP cũ](../KHO/11-evidence/gate3-4/Gate3-4-v1.6.18-bang-chung.zip) chỉ đọc khi cần kiểm claim lịch sử.
...
**Việc tiếp của hồ sơ Pha B, tạm dừng trong lượt mẫu:** PM/supervisor rà bản đồ PhaB và blocker nguồn23↔14. UI/control/tool/contract trace đã nộp; chưa khóa Contract/Data. Không tự mở Formal Gate5 hoặc triển khai sáu gap. Nếu sau này đóng theo Pilot thì mở lại lazy theo family.
...
| `data/` | Matrix177/authority/relation current; `contract-data-matrix.json` chỉ trỏ matrix385 lịch sử, 385leaf được bản đồ PhaB trace theo contract ở mức sơ bộ; chưa giải311UNKNOWN hoặc chứng minh fullproduction. |
...
PhaB bổ sung11nhóm gapcontract, gồm toolguide feedback_idUUID lệch integer ở finalsource. Đây là phát hiện để đồng bộ khi PM giao, không sửa rawproof. Bản đồ giữ phạmvi87bước;30vùng đề nghị sửa/ghép/bù/xác minh. Xem bản đồ thay vì đọc lại toàn kho.
