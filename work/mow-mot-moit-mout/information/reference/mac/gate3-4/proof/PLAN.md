# HISTORICAL v1.6.17 — kế hoạch trước code

Rev2 hiện hành: [proof/rev2/PLAN.md](rev2/PLAN.md). Nội dung dưới là rationale và nguồn baseline để replay; không phải current Next Action.
