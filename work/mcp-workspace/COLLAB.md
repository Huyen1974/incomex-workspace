...
- **Bước tiếp theo đã được Owner cho phép:** Host Claude soạn **một PROMPT triển khai duy nhất** cho hai gateway theo consensus P02 + freshness-debt ở trên; chưa RUN cho tới khi PROMPT được review/READY theo luật repo.
